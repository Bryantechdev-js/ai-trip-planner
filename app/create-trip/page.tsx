      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
        <Card className="max-w-md w-full">
          <CardContent className="p-8 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Trip Limit Reached</h2>

            <p className="text-gray-600 mb-6">
              You've reached your {tripLimitStatus.planLimits.intervalName} limit of{' '}
              {tripLimitStatus.planLimits.trips} trip
              {tripLimitStatus.planLimits.trips > 1 ? 's' : ''}. Upgrade your plan to create more
              amazing trips!
            </p>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-700">
                      {tripLimitStatus.remaining === -1 ? 'Unlimited' : tripLimitStatus.remaining}{' '}
                      trips remaining
                    </p>
                  </div>
                </div>
                <div className="text-right">
                  <p className="text-sm font-medium text-blue-900 capitalize">
                    {tripLimitStatus.subscription} Plan
                  </p>
          ...
          <CardContent className="space-y-4">
            {tripData.destination ? (
              <div className="space-y-3">
                ...
                {tripData.locationData?.attractions &&
                  tripData.locationData.attractions.length > 0 && (
                    <div>
              ...
              <div className="text-center py-8 text-gray-500">
                ...
                <p className="text-sm">
                  Your trip details will appear here as you chat with the AI.
                </p>
              </div>
            )}
          </CardContent>
