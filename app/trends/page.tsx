      ...
      const mockDestinations: TrendingDestination[] = [
        {
          ...
          description:
            'Tropical paradise with rich culture, beautiful temples, and world-class beaches.',
        ...
        },
        {
          ...
          description:
            'Iconic Greek island famous for white-washed buildings and breathtaking sunsets.',
        ...
        },
        {
          ...
          description:
            'Vibrant city nestled between mountains and ocean, rich in history and natural beauty.',
        ...
        },
        {
          ...
          description:
            'Ancient capital of Japan with thousands of temples, gardens, and traditional architecture.',
        ...
        },
        {
          ...
          description:
            "Gateway to Iceland's natural wonders including geysers, waterfalls, and Northern Lights.",
  ...
  const handleCreateTrip = (destination: TrendingDestination) => {
    ...
    localStorage.setItem(
      ...
      JSON.stringify({
        ...
        budget:
          destination.averageCost < 800
            ? 'Budget'
            : destination.averageCost < 1200
              ? 'Mid-range'
              : 'Luxury',
      })
    )
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Discover the world's most popular travel destinations, curated by AI and loved by
            travelers worldwide.
          </p>
        </div>
