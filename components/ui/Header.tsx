        ...
        <div className="hidden md:flex items-center space-x-2 sm:space-x-4">
          {!user ? (
            ...
            <>
              ...
              <Link href={"/dashboard"}>
                <Button variant={"default"} className="bg-primary cursor-pointer text-xs sm:text-sm px-3 py-2 mr-2">
                  Dashboard
                </Button>
              </Link>
              <Link href={"/create-trip"}>
                <Button variant={"default"} className="bg-primary cursor-pointer text-xs sm:text-sm px-3 py-2">
                  Create Trip
                </Button>
              </Link>
            </>
